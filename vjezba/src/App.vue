...
w-32">
 ...
 <input type="text" v-model="novoIme" class="border px-1 w-32 rounded"
placeholder="Ime...">
 <input type="number" v-model="noviBodovi" class="border px-1 w-16
rounded" placeholder="Bodovi...">
 ...
 <button @click="ucenici.unshift({'ime': novoIme, 'bodovi':
noviBodovi})"
 class="p-1 bg-blue-200 hover:bg-green-200 cursor-pointer rounded">
 unshift()
 </button>
 ...
 <div v-for="ucenik, i in ucenici.filter(u => u.bodovi >= minBodovi)"
:key="ucenik.ime">
