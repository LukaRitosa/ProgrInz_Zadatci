...
<div class="flex gap-2 items-center mt-2">
 Ime <input type="text" v-model="novoIme" class="p-1 border rounded
w-32">
 Bodovi <input type="number" v-model="noviBodovi" class="p-1 border
rounded w-12">
<button @click="addStudent()" class="p-1 border rounded hover:bgblue-200 bg-blue-300 cursor-pointer">
 Dodaj
</button>
</div>
...
<b>Filter:</b>
<div class="flex gap-2 items-center mt-2">
 Ime <input type="text" v-model="filterIme" class="p-1 border rounded
w-32">
 Min. Bodovi <input type="number" v-model="filterMinBodovi" class="p-1
border rounded w-12">
</div>
